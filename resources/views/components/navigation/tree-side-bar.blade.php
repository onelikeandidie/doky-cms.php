        ...
        <div class="tw-mt-2 tw-ml-2">
            <a href="{{ route('articles.create.orphan') }}"
               class="tw-px-2 tw-py-1 tw-text-sm">
                ...
                <x-icons.heroicon.solid.plus-circle class="tw-w-5 tw-h-5 tw-inline-block tw-text-neutral-600 dark:tw-text-neutral-400 hover:tw-text-black hover:dark:tw-text-white"/>
            </a>
        </div>
    @endcan
</div>
